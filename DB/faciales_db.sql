...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-09-2021 a las 01:01:13
...
('RC02', 'Silla 1', 'General', 'RCBR01'),
('RC03', 'Silla 2', 'General', 'RCBR01'),
...
('VV02', 'Cabina 02 Ariana', 'Ariana', 'VVTR01');
...
INSERT INTO `usuarios` (`idUsuarios`, `Nombre`, `Puesto`, `Sucursal_idSucursal`, `Sucursal_Marca_Marca_id`) VALUES
('0001', 'Gerentino_01', 'Gerente', 'RC01', 'RC'),
('0001', 'Gerentino_02', 'Gerente', 'RS01', 'RS'),
('0001', 'Gerentino_03', 'Gerente', 'VV01', 'VV'),
('0002', 'Humanitowo_01', 'Facialista', 'RC01', 'RC'),
('0002', 'Humanitowo_02', 'Facialista', 'RS01', 'RS'),
('0002', 'Humanitowo_03', 'Facialista', 'VV01', 'VV'),
('0003', 'Gentleman_01', 'Asesor', 'RC01', 'RC'),
('0003', 'Gentleman_02', 'Asesor', 'RS01', 'RS'),
('0003', 'Gentleman_03', 'Asesor', 'VV01', 'VV'),
('0004', 'Ring Rajas_01', 'Contact Center', 'RC01', 'RC'),
('0004', 'Ring Rajas_02', 'Contact Center', 'RS01', 'RS'),
('0004', 'Ring Rajas_03', 'Contact Center', 'VV01', 'VV');
...
ALTER TABLE `usuarios`
  ADD PRIMARY KEY (`idUsuarios`,`Sucursal_idSucursal`,`Sucursal_Marca_Marca_id`),
  ADD KEY `fk_Usuarios_Sucursal1` (`Sucursal_idSucursal`,`Sucursal_Marca_Marca_id`);
...
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_Usuarios_Sucursal1` FOREIGN KEY (`Sucursal_idSucursal`,`Sucursal_Marca_Marca_id`) REFERENCES `sucursal` (`idSucursal`, `Marca_Marca_id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
